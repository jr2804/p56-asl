...
| Docs pages             | `docs/`                                                        | `reference/api.md` (mkdocstrings), `reference/cli.md`, `reference/asl-method.md`, `reference/prefilter-bands.md`, `reference/extended-mode.md` (+ `extended-mode.svg`, generated by `scripts/gen_extended_mode_figure.py`); nav in `mkdocs.yml` |
